...
<head>
	...
	<title>Insert An Altos Stat Table</title>

	<link type="text/css" href="js/jquery/themes/base/ui.all.css" rel="stylesheet" />
	<link type="text/css" href="css/altos-toolbar.css" rel="stylesheet" />

	<script type="text/javascript" src="js/altos-toolbar-stat-table.js"></script>
...
<body>
	...
	<div align="left" id="altos-toolbar-dialog" >
		...
		<form action="/" method="get" accept-charset="utf-8">
			...
			<tr class="odd">
				<td colspan="2">
					<p><label for="altos-stat-table-D"><?php _e("Stats Date:"); ?></label><br><select id="D" name="D"><option>Loading....</option></select></p>
				</td>
			<tr>
			...
			<tr>
				<td colspan="2">
					...
					<input type="button" onclick="javascript:AltosToolbarDialog.insert(AltosToolbarDialog.localprintd)" class="button-primary submit button-primary" name="submit" value="Insert Stat Table">
					<br />
				</td>
			</tr>
