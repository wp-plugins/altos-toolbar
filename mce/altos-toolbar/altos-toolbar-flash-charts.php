...
<head>
	...
	<title>Insert An Altos Flash Chart</title>

	<link type="text/css" href="js/jquery/themes/base/ui.all.css" rel="stylesheet" />
	<link type="text/css" href="css/altos-toolbar.css" rel="stylesheet" />

	<script type="text/javascript" src="js/altos-toolbar-flash-charts.js"></script>
		...
		<form action="/" method="get" accept-charset="utf-8">
			...
			<tr class="odd">
				<td colspan="2">
					...
					Width: <input type="text" name="width" size="3">Height: <input type="text" name="height" size="3"><br />
					</p>
				</td>
			<tr>
			...
			<tr>
				<td colspan="2">
					...
					<input type="button" onclick="javascript:AltosToolbarDialog.insert(AltosToolbarDialog.localprintd)" class="button-primary submit button-primary"  name="submit" value="Insert Flash Chart">
					<br />
				</td>
			</tr>
