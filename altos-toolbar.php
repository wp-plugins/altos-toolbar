	...
	extends Altos_Post
	{
		...
		*/
		...
		function register_mce_buttons ($buttons)
			{
				array_push ($buttons, "altos_toolbar_charts", "altos_toolbar_regional_charts", "altos_toolbar_flash_charts", "altos_toolbar_stat_table");
				/**/
				return $buttons;
			}
		/**/
		function add_mce_external_plugins ($plugin_array)
			{
				$plugin_array["altos_toolbar_charts"] = $this->mce_plugin_path_js;
				$plugin_array["altos_toolbar_regional_charts"] = $this->mce_plugin_path_js;
				$plugin_array["altos_toolbar_flash_charts"] = $this->mce_plugin_path_js;
				$plugin_array["altos_toolbar_stat_table"] = $this->mce_plugin_path_js;
				/**/
				return $plugin_array;
			}
	}
